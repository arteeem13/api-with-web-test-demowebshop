...
@DisplayName("Добавление товаров в корзину неавторизованным пользователем")
public class AdditionalProductsWithoutAuthTests {
    private final String BASE_URL = "https://demowebshop.tricentis.com";
    private final String CART_URL = "https://demowebshop.tricentis.com/cart";
    ...
    @Test
    @DisplayName("Количество товаров в корзине увеличивается при дополнительном добавлении того же товара")
